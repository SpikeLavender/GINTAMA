...
import static com.totoro.consts.TotoroConst.CURRENT_USER;
...
public class PayController {
    ...
    @GetMapping("/wxpay")
    @ResponseBody
    public ResponseVo createJSAPI(@RequestParam(value = "userId", required = false) Integer userId,
    ...
    public Map<String, String> qrcode(@RequestParam("orderId") String orderId,
        ...
        //PayResponse response = payService.create(orderId, amount, bestPayTypeEnum);
        //支付方式不同，渲染就不同, WXPAY_NATIVE使用codeUrl,  ALIPAY_PC使用body
        ResponseVo<PayResponse> response = payService.create(null, orderId, null, amount, BestPayTypeEnum.WXPAY_NATIVE);
