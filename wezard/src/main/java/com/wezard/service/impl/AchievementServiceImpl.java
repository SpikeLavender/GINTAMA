...
import com.wezard.entity.Order;
import com.wezard.entity.User;
import com.wezard.enums.LevelEnum;
import com.wezard.enums.OrderStatusEnum;
import com.wezard.mapper.AchievementMapper;
import com.wezard.mapper.OrderMapper;
import com.wezard.mapper.UserMapper;
import com.wezard.service.AchievementService;
import com.wezard.utils.DateUtils;
import com.wezard.utils.JSONUtils;
import com.wezard.vo.*;
...
import static com.wezard.consts.WezardConst.ROOT_USER_PARENT_ID;
...
public class AchievementServiceImpl implements AchievementService {
     ...
     * @return
     */
    private Map<Integer, Achievement> calcAchievement(List<Order> orders, List<User> users) {
        //计算总业绩 {"userId": []}

        Map<Integer, Integer> idMap = users.stream()
                .collect(Collectors.toMap(User::getId, User::getParentId, (a, b) -> b));
